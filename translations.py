...
# Visible recovery messages shared by the website hand-off and WhatsApp
# fallback paths. Keeping these together makes the safety behaviour easy to
# audit across all supported languages.
TRANSLATIONS["en"].update(
    {
        "advocate_intake_invalid": (
            "We could not submit that advocate request because some details "
            "were missing or invalid. Please return to Ask an Advocate and "
            "send the prepared message again. No request was recorded."
        ),
        "recovery_menu": (
            "I could not match that message to the current options. Your "
            "progress is safe; please choose an option below or type MENU."
        ),
    }
)
TRANSLATIONS["hi"].update(
    {
        "advocate_intake_invalid": (
            "Kuch details missing ya invalid hone ke karan advocate request "
            "submit nahi ho saki. Ask an Advocate page par jaakar prepared "
            "message dobara bhejein. Koi request record nahi hui."
        ),
        "recovery_menu": (
            "Yeh message current options se match nahi hua. Aapki progress "
            "safe hai; neeche option choose karein ya MENU type karein."
        ),
    }
)
TRANSLATIONS["mr"].update(
    {
        "advocate_intake_invalid": (
            "Kahi mahiti apurna kinva chukichi aslyamule advocate request "
            "submit zali nahi. Ask an Advocate page varun prepared message "
            "punha pathva. Kontihi request record zali nahi."
        ),
        "recovery_menu": (
            "Ha message sadhyachya options shi julala nahi. Tumchi progress "
            "safe aahe; khalil option nivda kinva MENU type kara."
        ),
    }
)
